            ...
            <div className='grid grid-cols-2'>
                ...
                <div className="text-black dark:text-white">
                    <div className='flex items-center gap-3'>
                        <strong>{`hsl(${formatNumber(cmyktohsl[0])}deg ${formatNumber(cmyktohsl[1])}% ${formatNumber(cmyktohsl[2])}%)`}</strong>
                        <CustomTooltip
                            hexColor={`hsl(${formatNumber(cmyktohsl[0])}deg ${formatNumber(cmyktohsl[1])}% ${formatNumber(cmyktohsl[2])}%)`}
                            onCopy={onCopy}
                    ...
                    <div className="color-converter__channels">
                        <div className="color-converter__channel">Hue: <strong>{formatNumber(cmyktohsl[0])} °</strong></div>
                        <div className="color-converter__channel">Saturation: <strong>{formatNumber(cmyktohsl[1])} %</strong></div>
                        <div className="color-converter__channel">Lightness: <strong>{formatNumber(cmyktohsl[2])} %</strong></div>
                    </div>
                </div>
            </div>
