            ...
            <div className='grid grid-cols-2'>
                ...
                <div className="text-black dark:text-white">
                    <div className='flex items-center gap-3'>
                        <strong>{`lab(${formatNumber(hsvtolab[0])}, ${formatNumber(hsvtolab[1])}, ${formatNumber(hsvtolab[2])})`}</strong>
                        <CustomTooltip
                            hexColor={`lab(${formatNumber(hsvtolab[0])}, ${formatNumber(hsvtolab[1])}, ${formatNumber(hsvtolab[2])})`}
                            onCopy={onCopy}
                    ...
                    <div className="color-converter__channels">
                        <div className="color-converter__channel">Lightness: <strong>{formatNumber(hsvtolab[0])}</strong></div>
                        <div className="color-converter__channel">a: <strong>{formatNumber(hsvtolab[1])} </strong></div>
                        <div className="color-converter__channel">b: <strong>{formatNumber(hsvtolab[2])} </strong></div>
                    </div>
                </div>
            </div>
