...
//   const rgbtocmyk = convert.rgb.cmyk.raw(hexColor);
...
//   const [hslColor, setHslColor] = useState([0, 100, 14.70]);
//   const hsltorgb = convert.hsl.rgb(hslColor);
//   const hsltocmyk = convert.hsl.cmyk(hslColor);
//   const hsltohex = convert.hsl.hex(hslColor);
//   const hsltohsv = convert.hsl.hsv(hslColor);
//   const hsltolab = convert.hsl.lab.raw(hslColor);


//   const [hsvColor, setHsvColor] = useState([0, 100, 14.70]);
//   const hsvtorgb = convert.hsv.rgb(hsvColor);
//   const hsvtocmyk = convert.hsv.cmyk.raw(hsvColor);
//   const hsvtohex = convert.hsv.hex(hsvColor);
//   const hsvtohsl = convert.hsv.hsl.raw(hsvColor);
//   const hsvtolab = convert.hsv.lab.raw(hsvColor);


//   const [labColor, setLabColor] = useState([0, 100, 14.70]);
//   const labtorgb = convert.lab.rgb(labColor);
//   const labtocmyk = convert.lab.cmyk.raw(labColor);
//   const labtohex = convert.lab.hex(labColor);
//   const labtohsl = convert.lab.hsl.raw(labColor);
//   const labtohsv = convert.lab.hsv.raw(labColor);


//   const [cmykColor, setCmykColor] = useState([0, 100, 14.70, 10]);
//   const cmyktorgb = convert.cmyk.rgb(cmykColor);
//   const cmyktohex = convert.cmyk.hex(cmykColor);
//   const cmyktohsl = convert.cmyk.hsl(cmykColor);
//   const cmyktohsv = convert.cmyk.hsv(cmykColor);
//   const cmyktolab = convert.cmyk.lab.raw(cmykColor);
