...
const Home = () => {
    ...
    return (
        <>
            <section className='mt-[-72px] section-home p-[105px_0_80px] min-h-[75vh] bg-transparent relative flex flex-col justify-center'>
            ...
            <section className='container mt-4 grid gap-6'>
                <div className='grid grid-cols-2 gap-5 md:grid-cols-3'>
                    <div className='card p-0.5 card-home home-palette card-1-bg relative rounded-[12px] transition duration-300 '>
                        <div className='z-[2] relative flex flex-col items-center gap-3 rounded-[16px] hover:rounded-[12px] hover:shadow-none transition duration-300 dark:bg-dark-primary-base  p-4 dark:bg-mix-dark-surface-base dark:bg-mix-amount-[90] bg-light-primary-base bg-mix-light-surface-base bg-mix-amount-[90]'>
                    ...
                    <div onClick={() => navigate('gradient')} className='card p-0.5 cursor-pointer card-home home-palette card-2-bg relative rounded-[12px] transition duration-300 '>
                        <div className='z-[2] relative flex flex-col items-center gap-3 hover:rounded-[12px] hover:shadow-none transition duration-300 rounded-xl dark:bg-dark-primary-base p-4 dark:bg-mix-dark-surface-base dark:bg-mix-amount-[90] bg-light-primary-base bg-mix-light-surface-base bg-mix-amount-[90]'>
                ...
                <div className='dark:bg-dark-primary-base p-4 rounded-[12px] dark:bg-mix-dark-surface-base dark-primary-base dark:bg-mix-amount-[90] bg-light-surface-base bg-mix-light-surface-base bg-mix-amount-[90] '>
                    <h2 className='font-bold text-black dark:text-white text-[20px]'>Tools</h2>
                    <div className='grid grid-cols-4'>
                        <div className='dark:bg-dark-primary-base flex items-start gap-4 rounded-[12px] p-5 dark:bg-mix-dark-surface-base dark:bg-mix-amount-[95] bg-light-primary-base bg-mix-light-surface-base bg-mix-amount-[95]'>
