...
export default function ModalBox(props) {
    const fallbackColor = props.colors[props.colors.length - 1]; // Fallback to the last color
    const webkitGradient = `-webkit-linear-gradient(${props.angle || 'to bottom'}, ${props.colors.join(', ')})`;
    const standardGradient = `linear-gradient(${props.angle || 'to bottom'}, ${props.colors.join(', ')})`;
                                ...
                                <DialogPanel className="w-full max-w-lg rounded-xl bg-white/5 p-6 backdrop-blur-2xl">
                                    ...
                                    <div className="bg-gray-800 text-white p-4 rounded-lg">
                                        ...
                                        <button
                                            ...
                                            data-tooltip-content={copied ? 'Copied!' : 'Copy CSS'}
